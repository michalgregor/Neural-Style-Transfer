...
parser.add_argument("--tv_weight", dest="tv_weight", default=8.5e-5, type=float, help="Total Variation in the Weights")
...
style_feature_layers = ['block1_conv1', 'block1_conv2', 'block2_conv1', 'block2_conv2', 'block3_conv1',
...
# Activation shift in Gram Matrix
def gram_matrix(x):
    assert K.ndim(x) == 3
